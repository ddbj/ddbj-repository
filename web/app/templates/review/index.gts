...
import type ReviewIndexRoute from 'repository/routes/review/index';

type Model = Awaited<ReturnType<ReviewIndexRoute['model']>>;
...
// record says is drawn on the page instead: the list here, and the row's
// own record behind the accession.
          ...
          {{#each @model.accessions as |accession|}}
            <tr>
              <td class="font-monospace">
                <LinkTo @route="review.accession" @models={{array @model.token accession.accession}}>
                  {{accession.accession}}
                </LinkTo>
              </td>
