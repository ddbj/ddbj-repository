...
# docker build -t ddbj_repository .
# docker run -d -p 80:80 -e RAILS_MASTER_KEY=<value from config/master.key> --name ddbj_repository ddbj_repository
...
FROM docker.io/library/node:22.11.0 AS web
