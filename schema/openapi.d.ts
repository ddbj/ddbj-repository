...
export interface components {
    schemas: {
        ...
        AccessionRecord: {
             ...
             *     is not readable here yet, the record is too large to open one row at
             *     a time, its history cannot be reconstructed, there is no record yet,
             *     or the record does not carry this row. Telling one as another sends
             *     somebody looking in the wrong place — "not readable here yet" over a
             *     record that is fine blames the feature for a fact about the data.
             */
